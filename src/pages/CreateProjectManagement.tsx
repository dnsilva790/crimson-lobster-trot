  ...
  const handleCreateProject = useCallback(async () => {
    ...
    if (initialTodoistTaskId) {
      const updated = await updateTask(initialTodoistTaskId, {
        ...
        due_date: null,
        due_datetime: null,
        description: `[PROJETO 5W2H]: ${newProject.what}\n[ID]: ${newProject.id}\n[LINK]: /project-management/${newProject.id}\n\n${newProject.why}`,
      });
      if (updated) {
        toast.info("Tarefa original do Todoist atualizada e vinculada ao projeto 5W2H.");
      } else {
    ...
    <div className="p-4">
      ...
      <Card className="p-6 max-w-3xl mx-auto">
        ...
        <CardContent className="grid gap-6">
          ...
          <Button onClick={() => navigate("/project-management")} variant="outline" className="w-full mt-2">
            Cancelar
          </Button>
        </CardContent>
      </Card>
