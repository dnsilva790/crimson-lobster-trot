...
import {
  ...
  Database,
  Scale,
  Shuffle, // Adicionado Shuffle para NovoSeiso
} from "lucide-react";
import {
  Dialog,
  DialogContent,
...
const modules = [
  ...
  },
  {
    ...
    icon: FolderOpen,
    title: "SEIKETSU 5W2H",
    description: "Entendimento de Tarefas",
  ...
  },
  {
    ...
    icon: CalendarClock,
    title: "PLANEJADOR",
    description: "Sequenciamento de Tarefas",
    colorClass: "bg-purple-50 hover:bg-purple-100",
    activeColor: "border-purple-500",
  },
  {
  ...
  },
  {
    ...
    icon: Users,
    title: "FOLLOW-UP",
    description: "Acompanhamento Delegados",
    colorClass: "bg-cyan-50 hover:bg-cyan-100",
  ...
  },
  {
    ...
    colorClass: "bg-lime-50 hover:bg-lime-100",
    activeColor: "border-lime-500",
  },
  {
    path: "/internal-tasks",
    icon: ListTodo,
    title: "TAREFAS INTERNAS",
    description: "Gerencie tarefas locais",
